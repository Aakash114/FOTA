...
"input{background:#f1f1f1;border:0;padding:0 15px}body{background:#98db34;font-family:sans-serif;font-size:14px;color:#777}"
...
"<form name=loginForm>"
"<h1>ESP32 Login</h1>"
"<input name=userid placeholder='TCD Enrollment ID'> "
"<input name=pwd placeholder=Password type=Password> "
"<input type=submit onclick=check(this.form) class=btn value=Login></form>"
"<script>"
"function check(form) {"
"if(form.userid.value=='CS7NS6' && form.pwd.value=='CS7NS6')"
...
"<input type='submit' class=btn value='Update ESP32'>"
"<br><br>"
"<div id='prg'></div>"
